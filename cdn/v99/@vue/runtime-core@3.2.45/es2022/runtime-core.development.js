/* esm.sh - esbuild bundle(@vue/runtime-core@3.2.45) es2022 development */
// esm-build-4fe3df224060a6e07930b335b21b2a309c22d293-985e53e6/node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js
import {
  pauseTracking,
  resetTracking,
  isRef,
  ...
  isReadonly
} from '/cdn/v99/@vue/reactivity@3.2.45/es2022/reactivity.development.js';
import {
  EffectScope as EffectScope2,
  ReactiveEffect as ReactiveEffect2,
  customRef,
  effect,
  effectScope,
  getCurrentScope,
...
import {
  ...
  normalizeClass,
  normalizeStyle
} from '/cdn/v99/@vue/shared@3.2.45/es2022/shared.development.js';
import {
  camelize as camelize2,
  capitalize as capitalize2,
  normalizeClass as normalizeClass2,
  normalizeProps,
  normalizeStyle as normalizeStyle2,
  toDisplayString,
  toHandlerKey as toHandlerKey2
} from '/cdn/v99/@vue/shared@3.2.45/es2022/shared.development.js';
var stack = [];
...
function createHydrationFunctions(rendererInternals) {
  const {
    mt: mountComponent,
    p: patch,
    o: { patchProp, createText, nextSibling, parentNode, remove: remove2, insert, createComment }
  } = rendererInternals;
...
export {
  ...
  shallowReadonly2 as shallowReadonly,
  shallowRef,
  ssrContextKey,
  ssrUtils,
  stop,
