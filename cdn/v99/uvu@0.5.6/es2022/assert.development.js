/* esm.sh - esbuild bundle(uvu@0.5.6/assert) es2022 development */
// esm-build-bf4b027aedff4f553eb6ba38ee9e4eff823fab23-08f790e3/node_modules/uvu/assert/index.mjs
import { dequal } from '/cdn/v99/dequal@2.0.3/es2022/dequal.development.js';
import { compare, lines } from '/cdn/v99/uvu@0.5.6/es2022/diff.development.js';
function dedent(str) {
  str = str.replace(/\r?\n/g, '\n');
