/* esm.sh - esbuild bundle(acorn@8.8.1) es2022 development */
// esm-build-3177ddf08e0c502ff1bcd1f7f4ff175c4d0712f3-8dc055f2/node_modules/acorn/dist/acorn.mjs
...
pp$8.isAsyncFunction = function() {
  ...
  return (
    ...
    (next + 8 === this.input.length ||
      !(isIdentifierChar((after = this.input.charCodeAt(next + 8))) || (after > 55295 && after < 56320)))
  );
};
...
function isSyntaxCharacter(ch) {
  return (
    ch === 36 || (ch >= 40 && ch <= 43) || ch === 46 || ch === 63 || (ch >= 91 && ch <= 94) || (ch >= 123 && ch <= 125)
  );
}
