/* esm.sh - esbuild bundle(@babel/traverse@7.20.5) es2022 development */
...
import __globals$ from '/cdn/v99/globals@11.12.0/es2022/globals.development.js';
import ___babel_parser$ from '/cdn/v99/@babel/parser@7.20.5/es2022/parser.development.js';
import * as ___babel_helper_function_name$ from '/cdn/v99/@babel/helper-function-name@7.19.0/es2022/helper-function-name.development.js';
import * as ___babel_helper_hoist_variables$ from '/cdn/v99/@babel/helper-hoist-variables@7.18.6/es2022/helper-hoist-variables.development.js';
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/lib/virtual-types.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/visitors.js
var require_visitors = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/visitors.js'(exports) {
    'use strict';
    ...
    var { DEPRECATED_KEYS, FLIPPED_ALIAS_KEYS, TYPES } = _t;
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/cache.js
var require_cache = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/cache.js'(exports) {
    'use strict';
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/scope/lib/renamer.js
    ...
    var Renamer = class {
      ...
      rename(block) {
        ...
        const parentDeclar = path.find(
          path2 => path2.isDeclaration() || path2.isFunctionExpression() || path2.isClassExpression()
        );
        if (parentDeclar) {
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/scope/binding.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/scope/index.js
  ...
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/scope/index.js'(
      ...
      switch (node == null ? void 0 : node.type) {
        default:
          if (isModuleDeclaration(node)) {
            if (
              (isExportAllDeclaration(node) || isExportNamedDeclaration(node) || isImportDeclaration(node)) &&
              node.source
            ) {
    ...
    var Scope2 = class {
      ...
      toArray(node, i, arrayLikeIsIterable) {
        ...
        if (
          ...
          return callExpression(
            memberExpression(
              memberExpression(memberExpression(identifier('Array'), identifier('prototype')), identifier('slice')),
              identifier('call')
            ),
            [node]
          );
      ...
      hasBinding(name, noGlobals) {
        ...
        if (!noGlobals && Scope2.globals.includes(name)) return true;
        if (!noGlobals && Scope2.contextVariables.includes(name)) return true;
        return false;
      }
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/ancestry.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/inference/util.js
var require_util = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/inference/util.js'(
    ...
    var _t = ___babel_types$;
    var { createFlowUnionType, createTSUnionType, createUnionTypeAnnotation, isFlowType, isTSType } = _t;
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/inference/inferer-reference.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/inference/inferers.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/inference/index.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/replacement.js
var require_replacement = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/replacement.js'(
    ...
    var _t = ___babel_types$;
    var _helperHoistVariables = ___babel_helper_hoist_variables$;
    var {
      FUNCTION_TYPES,
    ...
    function replaceExpressionWithStatements(nodes) {
      ...
      const needToAwaitFunction =
        isParentAsync && _index.default.hasType(this.get('callee.body').node, 'AwaitExpression', FUNCTION_TYPES);
      const needToYieldFunction =
        isParentGenerator && _index.default.hasType(this.get('callee.body').node, 'YieldExpression', FUNCTION_TYPES);
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/evaluation.js
    ...
    function _evaluate(path, state) {
      ...
      if (path.isCallExpression()) {
        ...
        if (callee.isIdentifier() && !path.scope.getBinding(callee.node.name) && isValidCallee(callee.node.name)) {
          func = __global$[callee.node.name];
        }
        if (callee.isMemberExpression()) {
          ...
          if (
            ...
            context = __global$[object.node.name];
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/conversion.js
var require_conversion = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/conversion.js'(
    ...
    var _t = ___babel_types$;
    var _helperEnvironmentVisitor = ___babel_helper_environment_visitor$;
    var _helperFunctionName = ___babel_helper_function_name$;
    ...
    function arrowFunctionToExpression({
      ...
      if (!noNewArrows) {
        ...
        fn.replaceWith(
          callExpression(
            memberExpression((0, _helperFunctionName.default)(this, true) || fn.node, identifier('bind')),
        ...
        const parts = [
          assignmentExpression(
            ...
            memberExpression(
              ...
              computedKey ? assignmentExpression('=', computedKey, superProp.node.property) : superProp.node.property,
          ...
          assignmentExpression(
            ...
            binaryExpression(superProp.parentPath.node.operator[0], identifier(tmp.name), numericLiteral(1))
          )
        ];
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/introspection.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/context.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/lib/removal-hooks.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/removal.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/lib/hoister.js
var require_hoister = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/lib/hoister.js'(
    ...
    var _t2 = _t;
    var { react } = _t;
    var { cloneNode, jsxExpressionContainer, variableDeclaration, variableDeclarator } = _t2;
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/modification.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/family.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/comments.js
var require_comments = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/comments.js'(
    ...
    var _t = ___babel_types$;
    var { addComment: _addComment, addComments: _addComments } = _t;
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/lib/virtual-types-validator.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/index.js
var require_path = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/path/index.js'(
    ...
    var t = _t;
    var _cache = require_cache();
    var _generator = ___babel_generator$;
    ...
    {
      NodePath2.prototype._guessExecutionStatusRelativeToDifferentFunctions =
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/context.js
var require_context2 = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/context.js'(exports) {
    'use strict';
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/traverse-node.js
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/hub.js
var require_hub = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/hub.js'(exports) {
    'use strict';
    ...
    exports.default = Hub2;
  }
});

// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/index.js
var require_lib = __commonJS({
  'esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/node_modules/@babel/traverse/lib/index.js'(exports) {
    'use strict';
    ...
    var visitors2 = require_visitors();
    ...
    var { VISITOR_KEYS, removeProperties, traverseFast } = _t;
    ...
    exports.default = _default;
    traverse.visitors = visitors2;
    traverse.verify = visitors2.verify;
    traverse.explode = visitors2.explode;
...
// esm-build-076aa8266ba30ae27e2e3bc593380575ecb51c36-649296f0/mod.js
var __module = __toESM(require_lib());
var __esModule = true;
var { Hub, NodePath, Scope, visitors } = __module;
var { default: __default, ...__rest } = __module;
var mod_default = __default !== void 0 ? __default : __rest;
export { Hub, NodePath, Scope, __esModule, mod_default as default, visitors };
