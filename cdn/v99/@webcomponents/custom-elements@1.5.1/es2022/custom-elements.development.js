/* esm.sh - esbuild bundle(@webcomponents/custom-elements@1.5.1) es2022 development */
...
// esm-build-0883af9c720e57a0aa883f37db23574adc102687-26abd66b/node_modules/@webcomponents/custom-elements/custom-elements.min.js
var require_custom_elements_min = __commonJS({
  'esm-build-0883af9c720e57a0aa883f37db23574adc102687-26abd66b/node_modules/@webcomponents/custom-elements/custom-elements.min.js'() {
    (function() {
      'use strict';
      ...
      function X(a) {
        ...
        void 0 === ErrorEvent.prototype.initErrorEvent
          ...
          : ((e = document.createEvent('ErrorEvent')),
            e.initErrorEvent('error', false, true, b, c, f),
      ...
      function za(a) {
        if (false !== a.i) {
          a.i = false;
          for (var b = [], c = a.v, f = /* @__PURE__ */ new Map(), d = 0; d < c.length; d++) f.set(c[d], []);
          V(a.h, document, {
            upgrade: function(k) {
...
// esm-build-0883af9c720e57a0aa883f37db23574adc102687-26abd66b/mod.js
var __module = __toESM(require_custom_elements_min());
