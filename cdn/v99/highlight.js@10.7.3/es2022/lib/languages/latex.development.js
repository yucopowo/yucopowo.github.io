/* esm.sh - esbuild bundle(highlight.js@10.7.3/lib/languages/latex) es2022 development */
...
// esm-build-9214bdfe01f58b10f3553c072ccc608d8227acec-d9daecc5/node_modules/highlight.js/lib/languages/latex.js
      ...
      const VERBATIM = [
        ...
        ...[].concat(
          ...['', '\\*'].map(suffix => [
            ...
            BEGIN_ENV(
              'filecontents' + suffix,
              ARGUMENT_AND_THEN(ARGUMENT_M, VERBATIM_DELIMITED_ENV('filecontents' + suffix))
            ),
            ...['', 'B', 'L'].map(prefix =>
              BEGIN_ENV(
                prefix + 'Verbatim' + suffix,
                ARGUMENT_AND_THEN(ARGUMENT_O, VERBATIM_DELIMITED_ENV(prefix + 'Verbatim' + suffix))
              )
            )
          ])
        ),
        BEGIN_ENV(
          'minted',
          ARGUMENT_AND_THEN(ARGUMENT_O, ARGUMENT_AND_THEN(ARGUMENT_M, VERBATIM_DELIMITED_ENV('minted')))
        )
      ];
      return {
        name: 'LaTeX',
...
// esm-build-9214bdfe01f58b10f3553c072ccc608d8227acec-d9daecc5/mod.js
var __module = __toESM(require_latex());
