/* esm.sh - esbuild bundle(tiny-request-router@1.2.2) es2022 development */
// esm-build-e524663f4d2e24fab8585a729eb2a17afff7f0f1-3ad5c88a/node_modules/tiny-request-router/dist/router.mjs
...
function tokensToRegexp(tokens, keys, options) {
  ...
  if (end) {
    ...
    var isEndDelimited =
      typeof endToken === 'string' ? delimiter.indexOf(endToken[endToken.length - 1]) > -1 : endToken === void 0;
    if (!strict) {
