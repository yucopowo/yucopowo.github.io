/* esm.sh - esbuild bundle(uvu@0.5.3/assert) es2022 development */
// esm-build-f307efa204de79e74a1da23675dfa2da0d08efe6-b4660f13/node_modules/uvu/assert/index.mjs
import { dequal } from '/cdn/v78/dequal@2.0.2/es2022/dequal.development.js';
import { compare, lines } from '/cdn/v78/uvu@0.5.3/es2022/diff.development.js';
function dedent(str) {
  str = str.replace(/\r?\n/g, '\n');
