/* esm.sh - esbuild bundle(events@3.3.0) es2022 production */
var P = Object.create;
...
var m = W((J, h) => {
  ...
  function E(t, e, n, r) {
    ...
    if (
      ...
      u === void 0
        ...
        : (u.newListener !== void 0 && (t.emit('newListener', e, n.listener ? n.listener : n), (u = t._events)),
          (s = u[e])),
      s === void 0)
    )
      (s = u[e] = n), ++t._eventsCount;
    else if (
      (typeof s == 'function' ? (s = u[e] = r ? [n, s] : [s, n]) : r ? s.unshift(n) : s.push(n),
      (i = b(t)),
  ...
  f.prototype.removeListener = o(function(e, n) {
    ...
    if (r === n || r.listener === n)
      ...
      u === 0 ? r.shift() : k(r, u),
        r.length === 1 && (i[e] = r[0]),
        i.removeListener !== void 0 && this.emit('removeListener', e, a || n);
    }
    return this;
  }, 'removeListener');
...
var N = y(m()),
  M = y(m()),
  { EventEmitter: Q, init: V, listenerCount: X, once: Y } = M,
  { default: B, ...D } = M,
  Z = N.default ?? B ?? D;
