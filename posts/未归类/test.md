...
**hast** is a specification for representing [HTML][] (and embedded [SVG][] or [MathML][]) as an abstract [syntax tree][syntax-tree]. It implements the **[unist][]** spec.

This document may not be released. See [releases][] for released documents. The latest released version is [`2.4.0`][latest].
